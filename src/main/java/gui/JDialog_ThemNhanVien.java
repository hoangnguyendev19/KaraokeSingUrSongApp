			...
			try {
				...
				if (result == JOptionPane.YES_OPTION) {
					if (DAO_NV.capNhatNhanVien(nv)) {
						if (trangThai == "Đang làm" || trangThai == "Nghỉ phép") {
							DAO_TK.capNhatTrangThai_TheoMaNhanVien(maNhanVien, true);
						} else if (trangThai == "Nghỉ việc") {
							DAO_TK.capNhatTrangThai_TheoMaNhanVien(maNhanVien, false);
						}
